(function () {
	...
	const rules$y = [{"selector":"button ","rule":"background: var(--active-element-bg-color);color: var(--element-text-color);border: var(--element-border);border-radius: var(--element-border-radius);font-size: 12px;outline: none;padding: 1px 4px;box-sizing: border-box;"},{"selector":"button.big ","rule":"padding: 5px 15px;"},{"selector":"button.main ","rule":"background: var(--element-bg-color-selected);border: 1px solid #268ce4;"},{"selector":"button.main:hover ","rule":"background: var(--active-text-color);"},{"selector":"button[disabled] ","rule":"background: var(--element-bg-color);border: var(--element-border);box-sizing: border-box;opacity: 0.5;"}];
				const css$z = {
					install:() => {
	...
	const rules$w = [{"selector":"input, textarea ","rule":"background: var(--input-bg-color);color: var(--element-text-color);border: var(--input-border);border-radius: var(--element-border-radius);font-size: 12px;outline: none;padding: 2px 5px;box-sizing: border-box;"},{"selector":"input:disabled, textarea:disabled ","rule":"opacity: 0.5;"}];
				const css$x = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$v = [{"selector":"table ","rule":"color: var(--text-color);"}];
				const css$w = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$s = [{"selector":"select ","rule":"background: var(--element-bg-color);border: var(--element-border);border-radius: var(--element-border-radius);outline: none;color: var(--element-text-color);"},{"selector":"select option ","rule":""}];
				const css$t = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$r = [{"selector":".error ","rule":"color: red;"}];
				const css$s = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$q = [{"selector":":root ","rule":"--bg-color: #3c3f41;--text-color: #bbb;--active-text-color: #2597ed;--active-text-color-hover: #549bff;--textDescription-text-color: #686868;--element-bg-color: #3c3f41;--element-bg-color-hover: #262833;--element-bg-color-selected: #2373c4;--element-border-color: #686868;--element-border: 1px solid var(--element-border-color);--element-border-radius: 2px;--element-text-color: #eee;--element-text-color-hover: #eee;--input-bg-color: #282a36;--input-border-color: #333;--input-border-width: 1px;--input-border: var(--input-border-width) solid var(--input-border-color);--active-element-bg-color: #4c5052;--inactive-element-text-color: #aaa;--head-background: #444;--head-color: #ccc;--body-bg-color: #202025;--space-bg-color: #101019;--space-border: 1px solid #444;--warning-text-color: #ff0000;"}];
				const css$r = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$p = [{"selector":"i.ico ","rule":"filter: brightness(0) invert(1) brightness(100%);"},{"selector":".ico.actionHover:hover ","rule":"filter: invert(35%) sepia(19%) saturate(4417%) hue-rotate(186deg) brightness(98%) contrast(83%);"},{"selector":".ico.errorHover:hover ","rule":"filter: invert(28%) sepia(96%) saturate(6757%) hue-rotate(356deg) brightness(93%) contrast(120%);"}];
				const css$q = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	let Tpl_wrapper = class extends RP {
						constructor(model, logic) {
							const tree = {"vDom":{"tree":[{"type":"component","tagName":"x-menu","attrs":{"config":{"valueOut":"m.menu","modelDepends":[{"refName":"m","modelPath":"menu","valueOutRender":"m.menu","jsonInnerPath":""}],"type":"json"}},"childNodes":[]},{"type":"component","tagName":"x-panelspace","attrs":{},"childNodes":[]}]}};
							super(tree, model, logic);
						}
					};
					customElements.define('x-tpl_wrapper', Tpl_wrapper);

	const rules$n = [{"selector":"x-tpl_wrapper ","rule":"display: flex;flex-direction: column;justify-content: center;height: 100%;"}];
				const css$n = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$m = [{"selector":"x-panelspace ","rule":"display: block;width: 100%;height: 100%;"},{"selector":"x-panelspace > * ","rule":"width: 100%;height: 100%;"},{"selector":"x-panelspace x-panels-panel[name='left'] ","rule":"border-right: 1px solid #444;"},{"selector":"x-panelspace x-panels-panel[name='leftContent'] ","rule":"border-right: 1px solid #444;position: relative;"},{"selector":"x-panelspace x-panels-panel[name='right'] ","rule":"border-left: 1px solid #444;"},{"selector":"x-panelspace x-panels-panel[name='rightContent'] ","rule":"border-left: 1px solid #444;position: relative;"},{"selector":"x-panelspace x-panels-panel[name='top'] ","rule":"border-bottom: 1px solid #444;"},{"selector":"x-panelspace x-panels-panel[name='topContent'] ","rule":"border-bottom: 1px solid #444;position: relative;"},{"selector":"x-panelspace x-panels-panel[name='bottom'] ","rule":"border-top: 1px solid #444;"},{"selector":"x-panelspace x-panels-panel[name='bottomContent'] ","rule":"border-top: 1px solid #444;position: relative;"},{"selector":"x-panels-panel > x-draggable ","rule":"display: block;width: 100%;height: 100%;"},{"selector":"x-panelspace x-panels-panel x-draggable[orientation='horizontal'] x-panelspace-paneltile ","rule":"display: block;margin: 2px 10px;"},{"selector":"x-panelspace x-panels-panel x-draggable[orientation='verticalLeft'] x-panelspace-paneltile,x-panelspace x-panels-panel x-draggable[orientation='verticalRight'] x-panelspace-paneltile ","rule":"display: block;margin: 10px 2px;"},{"selector":"x-panelspace x-panels-panel x-draggable x-draggable-item.active ","rule":"background: var(--active-element-bg-color);"},{"selector":"x-panelspace x-panels-panel .menu ","rule":"background: var(--element-bg-color-hover);border-bottom: var(--element-bg-color);height: 24px;padding-left: 5px;box-sizing: border-box;"},{"selector":"x-panelspace x-panels-panel .menu > item ","rule":"margin-right: 5px;display: inline-block;margin-top: 1px;height: 22px;padding: 3px;box-sizing: border-box;"},{"selector":"x-panelspace x-panels-panel .menu > item:hover ","rule":"background: var(--element-bg-color);border-radius: var(--element-border-radius);"},{"selector":"x-panelspace x-panels-panel .menu > item > * ","rule":"vertical-align: middle;display: inline-block;"}];
				const css$m = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$l = [{"selector":"x-panels ","rule":"display: grid;grid-gap: 0;height: 100%;width: 100%;"}];
				const css$l = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$i = [{"selector":"x-tpl_projectinfo .menu item * ","rule":"cursor: default;"},{"selector":"x-tpl_projectinfo > * ","rule":"display: flex;flex-direction: column;height: 100%;"},{"selector":"x-tpl_projectinfo > x-tree ","rule":"margin-top: 10px;box-sizing: border-box;"}];
				const css$i = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$h = [{"selector":"x-tpl_tree_item .item ","rule":"display: block;padding-top: 3px;padding-bottom: 3px;-webkit-user-select: none; -ms-user-select: none; user-select: none;"},{"selector":"x-tpl_tree_item .item.selected ","rule":"background: var(--element-bg-color-selected);"},{"selector":"x-tpl_tree_item .item > * ","rule":"display: inline-block;vertical-align: middle;cursor: default;"},{"selector":"x-tpl_tree_item .item > span > * ","rule":"vertical-align: middle;"},{"selector":"x-tpl_tree_item .item > span > span ","rule":"vertical-align: middle;margin-left: 5px;"}];
				const css$h = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$g = [{"selector":"x-contextmenu ","rule":"position: absolute;background: var(--element-bg-color);border: var(--element-border);"},{"selector":"x-contextmenu x-menu-item ","rule":"position: relative;display: block;font-size: 12px;cursor: default;"},{"selector":"x-contextmenu x-menu-item > div ","rule":"padding: 6px 10px 4px;"},{"selector":"x-contextmenu x-menu-item:hover ","rule":"background: var(--element-bg-color-selected);"}];
				const css$g = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$f = [{"selector":"x-tpl_createproject ","rule":"display: block;padding: 20px;"},{"selector":"x-tpl_createproject table ","rule":"border-collapse: collapse;"},{"selector":"x-tpl_createproject table tr td ","rule":"padding: 0;"},{"selector":"x-tpl_createproject table tr td:nth-child(1) ","rule":"width: 100px;"},{"selector":"x-tpl_createproject table tr td:nth-child(2) ","rule":"font-size: 0;"},{"selector":"x-tpl_createproject table tr td:nth-child(2) > * ","rule":"width: 200px;margin: 5px 0;"},{"selector":"x-tpl_createproject .control ","rule":"float: right;"},{"selector":"x-tpl_createproject .control button ","rule":"margin: 20px 0 0 10px;"}];
				const css$f = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$e = [{"selector":"x-dropdown ","rule":"display: inline-block;position: relative;margin: 0;padding: 0;font-size: 0;"},{"selector":"x-dropdown[disabled='disabled'] ","rule":"opacity: 0.5;"},{"selector":"x-dropdown div[name='selectedName'] ","rule":"background: var(--input-bg-color);color: var(--element-text-color);border: var(--input-border);border-radius: var(--element-border-radius);padding: 2px 20px 2px 4px;position: relative;box-sizing: border-box;height: 20px;"},{"selector":"x-dropdown div[name='selectedName']::after ","rule":"position: absolute;right: 3px;"},{"selector":"x-dropdown div[name='selectedName'].expanded::after ","rule":"display: inline-block;content: '↥';"},{"selector":"x-dropdown div[name='selectedName']:not(.expanded)::after ","rule":"display: inline-block;content: '↧';"},{"selector":"x-dropdown div[name='listContainer'] ","rule":"border: var(--element-border);border-radius: var(--element-border-radius);background: var(--input-bg-color);color: var(--element-text-color);overflow: hidden;position: absolute;margin-top: 1px;left: 0;width: 100%;box-sizing: border-box;z-index: 10000;"},{"selector":"x-dropdown div[name='list'] ","rule":"overflow-y: auto;overflow-x: hidden;max-height: 100%;display: block;"},{"selector":"x-dropdown div[name='listContainer']:not(.expanded) ","rule":"display: none;"},{"selector":"x-dropdown div[name='listContainer'].expanded ","rule":"display: block;"},{"selector":"x-dropdown item ","rule":"display: block;padding: 2px 4px;font-size: 12px;cursor: default;"},{"selector":"x-dropdown item:hover ","rule":"background: var(--element-bg-color-selected);"},{"selector":"x-dropdown splitter ","rule":"display: block;height: 1px;width: 100%;background: var(--element-border-color);"}];
				const css$e = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$6 = [{"selector":"x-ide-panel-console ","rule":"display: block;position: absolute;top: 0;bottom: 0;left: 0;right: 0;"},{"selector":"x-ide-panel-console div.menu ","rule":"text-align: right;"},{"selector":"x-ide-panel-console > * ","rule":"display: flex;flex-direction: column;height: 100%;"},{"selector":"x-ide-panel-console div[name='log'] ","rule":"display: block;flex: 1;overflow: auto;padding: 10px;box-sizing: border-box;"},{"selector":"x-ide-panel-console div[name='log'] > div ","rule":"display: table-row;margin-bottom: 10px;"},{"selector":"x-ide-panel-console div[name='log'] > div > * ","rule":"display: table-cell;"},{"selector":"x-ide-panel-console div[name='log'] > div > div.arrow ","rule":"color: gray;padding-left: 5px;padding-right: 10px;"}];
				const css$6 = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	const rules$4 = [{"selector":"x-aceeditor ","rule":"display: flex;flex-direction: column;height: 100%;border: var(--input-border);box-sizing: border-box;"}];
				const css$4 = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
	...
	ace.define("ace/mode/jsdoc_comment_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(require, exports, module){    var oop = require("../lib/oop");
	...
	ace.define("ace/mode/javascript_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/jsdoc_comment_highlight_rules","ace/mode/text_highlight_rules"], function(require, exports, module){    var oop = require("../lib/oop");
	...
	ace.define("ace/mode/matching_brace_outdent",["require","exports","module","ace/range"], function(require, exports, module){    var Range = require("../range").Range;
	...
	ace.define("ace/mode/folding/cstyle",["require","exports","module","ace/lib/oop","ace/range","ace/mode/folding/fold_mode"], function(require, exports, module){    var oop = require("../../lib/oop");
	...
	ace.define("ace/mode/javascript",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/javascript_highlight_rules","ace/mode/matching_brace_outdent","ace/worker/worker_client","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle"], function(require, exports, module){    var oop = require("../lib/oop");
	...
	const rules = [{"selector":"x-tab ","rule":"display: flex;flex-direction: column;height: 100%;"},{"selector":"x-tab x-tpl_head * ","rule":"cursor: default;"},{"selector":"x-tab div.tabs ","rule":"display: block;background: var(--head-background);"},{"selector":"x-tab div.tabs > * ","rule":"display: inline-block;padding: 3px 10px;border-bottom: 3px solid var(--head-background);"},{"selector":"x-tab div.tabs > * > * ","rule":"vertical-align: middle;"},{"selector":"x-tab div.tabs > html-fragment:not(.selected):hover ","rule":"background: var(--element-bg-color-hover);border-bottom: 1px solid var(--active-element-bg-color);padding-bottom: 5px;"},{"selector":"x-tab div.tabs > *.selected ","rule":"background: var(--active-element-bg-color);border-bottom: 3px solid var(--element-bg-color-selected);"},{"selector":"x-tab > div.content ","rule":"display: block;flex: 1;position: relative;"},{"selector":"x-tab > div.content > * ","rule":"position: absolute;max-width: 100%;top: 0;left: 0;right: 0;bottom: 0;overflow: auto;"}];
				const css = {
					install:() => {
						let cssStyle = document.body.querySelector("style");
						if (!cssStyle) {
